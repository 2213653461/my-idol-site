...
export default function Home() {
  return (
    ...
    >
      ...
      {/* ================== 顶部导航栏 ================== */}
      <nav className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between p-4 mb-8 md:mb-12 relative z-10 border-b border-white/10 animate-in slide-in-from-top duration-500">
         ...
         <div className="flex flex-wrap justify-center gap-6 text-sm md:text-base font-medium text-gray-300">
           ...
           <Link href="/offline" className="hover:text-purple-400 transition">一日店长</Link>
           <Link href="/game" className="hover:text-cyan-400 transition">影游</Link>
         </div>
      </nav>
      ...
      <main className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative z-10 my-auto pb-12">
        ...
        {/* --- 👈 左侧区域：纯个人信息 (去掉了倒计时) --- */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8 animate-in slide-in-from-left duration-700 text-white h-full sticky top-24">
          ...
          {/* 3. 社交媒体按钮栏 */}
          <div className="grid grid-cols-2 gap-2 w-full max-w-[220px] md:mx-0 mx-auto pt-2">
             {/* Weibo */}
            <a href="https://m.weibo.cn/u/2949722457?t=0&luicode=10000011&lfid=100103type%3D3%26q%3D%E7%8E%8B%E6%B6%B5%26t%3D&launchid=10000360-page_H5" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-1.5 bg-white/5 hover:bg-[#E6162D] border border-white/10 hover:border-[#E6162D] rounded-full transition-all duration-300 text-xs text-gray-300 hover:text-white backdrop-blur-sm">
              微博
            </a>
            {/* Bilibili */}
            <a href="https://space.bilibili.com/382211078?spm_id_from=333.337.0.0" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-1.5 bg-white/5 hover:bg-[#FB7299] border border-white/10 hover:border-[#FB7299] rounded-full transition-all duration-300 text-xs text-gray-300 hover:text-white backdrop-blur-sm">
              Bilibili
            </a>
            {/* Douyin */}
            <a href="https://www.douyin.com/user/MS4wLjABAAAALFdBYwOJ_j1XRBnO_qbxPfcDl2OMKGcACPIZ4Glpp1k?from_tab_name=main" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-1.5 bg-white/5 hover:bg-black border border-white/10 hover:border-white rounded-full transition-all duration-300 text-xs text-gray-300 hover:text-white backdrop-blur-sm">
              抖音
            </a>
            {/* RED */}
            <a href="https://www.xiaohongshu.com/user/profile/5a1ff08e11be102c3ac9183e?xsec_token=ABNUj9-YoKGfK63kWbFAOzMw1eGb79_PilmE248GzVJTg%3D&xsec_source=pc_search" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-1.5 bg-white/5 hover:bg-[#FF2442] border border-white/10 hover:border-[#FF2442] rounded-full transition-all duration-300 text-xs text-gray-300 hover:text-white backdrop-blur-sm">
              小红书
            </a>
          </div>
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-5 animate-in slide-in-from-right duration-700 delay-100 text-white">
          ...
          {/* 👇 2. 原有的功能入口 */}
          <Link href="/gallery" className="group relative h-40 bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:border-pink-500/60 transition shadow-lg">
          ...
          <Link href="/clips" className="group relative h-40 bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/60 transition shadow-lg">
          ...
          <Link href="/music" className="group relative h-40 bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:border-green-500/60 transition shadow-lg">
          ...
          <Link href="/works" className="group relative h-40 bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:border-yellow-500/60 transition shadow-lg">
